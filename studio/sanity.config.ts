...
const singletonTypes = ['siteSettings', 'homePage', 'servicesPage', 'contactPage', 'blogPage', 'aboutPage']
...
export default defineConfig({
  ...
  projectId: process.env.SANITY_STUDIO_PROJECT_ID || 'slklyupp',
      ...
      structure: (S) =>
        S.list()
          ...
          .items([
            ...
            singleton(S, 'Page Articles', 'blogPage'),
